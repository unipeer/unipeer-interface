...
const BasicDialogV3: React.FC<BasicDialogProp> = ({
  dialogTitle,
  isCancellable,
  dialogChild,
  onCloseCallback,
      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-start sm:p-0">
            ...
            >
              <Dialog.Panel className="flex flex-col transform overflow-hidden rounded-lg bg-white text-left shadow-xl py-[56px] px-[64px] transition-all sm:my-8 sm:w-full sm:max-w-[843px] sm:rounded-32 gap-4">
