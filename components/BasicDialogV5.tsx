...
const BasicDialogV5: React.FC<BasicDialogProp> = ({
  dialogTitle,
  isCancellable,
  dialogChild,
  onCloseCallback,
      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-start sm:p-0">
            ...
            >
              <Dialog.Panel className="flex flex-col transform overflow-hidden rounded-lg w-[618px] bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[618px] sm:rounded-32 gap-8 py-14 px-16">
                <div className="sm:flex flex-row justify-between items-center">
                  <div className="font-bold text-dark-800 text-24 font-headings">
                    {dialogTitle}
                  </div>
                  {isCancellable ? (
                    <div
