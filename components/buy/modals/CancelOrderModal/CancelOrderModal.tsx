...
type CancelOrderModalProp = {
  cancelOrderCallback: MouseEventHandler<any>;
};

export function CancelOrderModal<CancelOrderModalProp>({
  cancelOrderCallback,
}) {
  return (
    <div className="text-xl text-dark-black-500">
      You are about to cancel this buy order?
      <button
        type="submit"
        className="flex flex-row mt-8 items-center justify-center w-auto max-h-[4px] rounded-lg bg-accent-1 py-8 gap-0"
